...
iris_df <- read_csv("/cloud/project/Week01/iris.csv", col_names = c("Petal.Length", "Petal.Width", "Sepal.Length", "Sepal.Width", "Species"))
...
wilcox.test(iris_df$Petal.Length[iris_df$Species == "Iris-setosa"], iris_df$Petal.Length[iris_df$Species == "Iris-versicolor"])
wilcox.test(iris_df$Petal.Length[iris_df$Species == "Iris-setosa"], iris_df$Petal.Length[iris_df$Species == "Iris-virginica"])
